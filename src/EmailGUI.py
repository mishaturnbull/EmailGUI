...
from prereqs import CONFIG, smtplib, sys, os, \
                    MIMEMultipart, MIMEBase, MIMEText, COMMASPACE, \
                    formatdate, encoders, \
                    BEST_RANGE, BEST_INPUT, \
                    tk, filedialog, scrolledtext, ttk, messagebox, \
                    FakeSTDOUT, EmailSendError, EmergencyStop, \
                    POPUP_ERRORS, GUI_DOC, args, MAX_RESP_LEN
